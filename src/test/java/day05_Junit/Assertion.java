...
public class Assertion {
    ...
    public void test02(){
       ...
       /* onceden boyle yapıyorduk; ama artık bu isi assert ile yapıtoruz
        if (sayfaResmi.isDisplayed()){
            System.out.println("test passed");
        }else System.out.println("test failed");
        */
    // Assert.assertFalse(sayfaResmi.isDisplayed()); tru old bildigimz halde false dersek hata verir test calısmaz
    }
    @Test
    public void test03(){
