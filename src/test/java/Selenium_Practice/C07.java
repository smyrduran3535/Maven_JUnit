     ...
     //- Genişliği 225 ve Uzunluğu 225 olan resimlerin hepsine tıklayalım
       // - Her sayfanın sayfa başlığını yazdıralım
        for (int i = 0; i < 24; i++) {
            ...
            urunler.get(i).click();//butun bu sarta uyan hepsini click yapacak
            Thread.sleep(2000);
            System.out.println(i+". başlık : "+driver.getTitle());//sayfaya tıklayıp sayfa baslıgına tıklar sonra back ile geri doner
            Thread.sleep(2000);
