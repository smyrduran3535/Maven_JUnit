...
//<iframe src="/index.php" width="100%" height="300" style="border:1px solid black;">:‘Applications lists’ elementi iframe in icinde
        driver.switchTo().frame(0);//index 0 dan baslar. ilk iframei switch yapıyoruz
        ...
        // Assert.assertTrue(driver.findElement(By.xpath("//*[.='Applications lists']")).isDisplayed()); kull.
        ...
        List<WebElement> list=driver.findElements(By.tagName("iframe")); tum iframe leri liste olarak almamızı saglar
