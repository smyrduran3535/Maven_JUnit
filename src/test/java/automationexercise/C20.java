...
public class C20 extends TestBase {
    ...
    public void test() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@data-qa='login-email']")).sendKeys("sevinc333techpro@gmail.com");
        driver.findElement(By.xpath("//input[@placeholder='Password']")).sendKeys("Sevinc333");
