...
//7. Enter name, email and review
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Sevinc");
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("sevinc333techpro@gmail.com");
        driver.findElement(By.xpath("//textarea[@id='review']")).sendKeys("testcase");
